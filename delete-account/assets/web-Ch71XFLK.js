import{W as Ln}from"./index-CTk4k2QK.js";import{_ as Dt,g as Mt,a as Un,b as Dn,c as m,d as y,e as qe,i as Je,p as Mn,q as Y,f as te,h as ne,F as Ye,E as Xe,j as Vn,k as Wn,l as Fn,L as Hn,m as Vt,S as de,n as k,o as xn,r as Gn,D as $n,s as jn,t as qn,u as lt,C as ut,v as dt,w as Bn}from"./index.esm-BXFBjz6i.js";import{ProviderId as B,Persistence as ge}from"./index-N0zXhFaq.js";function Wt(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Kn=Wt,Ft=new Xe("auth","Firebase",Wt());/**
 * @license
 ...
 */const Pe=new Hn("@firebase/auth");function we(n,...e){Pe.logLevel<=Vt.WARN&&Pe.warn(`Auth (${de}): ${n}`,...e)}function Ee(n,...e){Pe.logLevel<=Vt.ERROR&&Pe.error(`Auth (${de}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zn(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Ze()||jn()||"connection"in navigator)?navigator.onLine:!0}function Jn(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
